...
from demotodoapp.api_v1.accounts.serializers import (
    ChangePasswordSerializer,
    LoginSerializer,
    ReadUserSerializer,
)
from demotodoapp.api_v1.serializers import DummyDetailAndStatusSerializer, DummyDetailSerializer, EmptySerializer
