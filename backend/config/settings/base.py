...
)  # (demotodoapp/config/settings/base.py - 3 = demotodoapp/)

APPS_DIR = ROOT_DIR.path("demotodoapp")
...
DATABASES = {"default": env.db("DATABASE_URL",
                               default="postgres://localhost:5432/todos")}
...
LOCAL_APPS = [
    "demotodoapp.main.apps.MainConfig",
    "demotodoapp.api_v1.apps.ApiV1Config",
    "demotodoapp.ws_v1.apps.WsV1Config",
    "demotodoapp.permissions.apps.PermissionsConfig",
    "demotodoapp.users.apps.UsersConfig",
    "demotodoapp.notifications.apps.NotificationsConfig",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_SCHEMA_CLASS": "config.schema.TodoAppAutoSchema",
    "EXCEPTION_HANDLER": "demotodoapp.api_v1.exception_handler.exception_handler",
...
MIGRATION_MODULES = {"sites": "demotodoapp.contrib.sites.migrations"}
